...
/**
 * A factory class responsible for creating and managing different types of
 * decorations.
 * <p>
 * This class implements a registry-based Factory Pattern, allowing for dynamic
 * instantiation of
 * decorative elements.
 * <p>
 * By using {@link Supplier} functions, it decouples the creation logic from
 * the rest of the model, enabling easy expansion of new decoration types like
 * static or animated
 * (tickable) elements.
 * </p>
 */
public class DecorationFactory {
    ...
    public DecorationFactory(IAquarium aquarium) {
        ...
        register("anchor", () -> new Decoration(aquarium, new Vec3<>(0, 0, depth)));
    }
